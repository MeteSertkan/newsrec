...
from models.naml_simple.news_encoder import NewsEncoder
from models.naml_simple.user_encoder import UserEncoder
...
class NAML_Simple(pl.LightningModule):
    def __init__(self, config=None, pretrained_word_embedding=None):
        super(NAML_Simple, self).__init__()
        self.config = config
